...
"""
Base.@kwdef mutable struct PlaybookRun <: OpenAPI.APIModel
    ...
    function PlaybookRun(id, name, description, is_active, owner_user_id, team_id, channel_id, create_at, end_at, delete_at, active_stage, active_stage_title, post_id, playbook_id, checklists, )
        OpenAPI.validate_property(PlaybookRun, Symbol("id"), id)
        OpenAPI.validate_property(PlaybookRun, Symbol("name"), name)
        OpenAPI.validate_property(PlaybookRun, Symbol("description"), description)
        OpenAPI.validate_property(PlaybookRun, Symbol("is_active"), is_active)
        OpenAPI.validate_property(PlaybookRun, Symbol("owner_user_id"), owner_user_id)
        OpenAPI.validate_property(PlaybookRun, Symbol("team_id"), team_id)
        OpenAPI.validate_property(PlaybookRun, Symbol("channel_id"), channel_id)
        OpenAPI.validate_property(PlaybookRun, Symbol("create_at"), create_at)
        OpenAPI.validate_property(PlaybookRun, Symbol("end_at"), end_at)
        OpenAPI.validate_property(PlaybookRun, Symbol("delete_at"), delete_at)
        OpenAPI.validate_property(PlaybookRun, Symbol("active_stage"), active_stage)
        OpenAPI.validate_property(PlaybookRun, Symbol("active_stage_title"), active_stage_title)
        OpenAPI.validate_property(PlaybookRun, Symbol("post_id"), post_id)
        OpenAPI.validate_property(PlaybookRun, Symbol("playbook_id"), playbook_id)
        OpenAPI.validate_property(PlaybookRun, Symbol("checklists"), checklists)
        return new(id, name, description, is_active, owner_user_id, team_id, channel_id, create_at, end_at, delete_at, active_stage, active_stage_title, post_id, playbook_id, checklists, )
    end
end # type PlaybookRun

const _property_types_PlaybookRun = Dict{Symbol,String}(Symbol("id")=>"String", Symbol("name")=>"String", Symbol("description")=>"String", Symbol("is_active")=>"Bool", Symbol("owner_user_id")=>"String", Symbol("team_id")=>"String", Symbol("channel_id")=>"String", Symbol("create_at")=>"Int64", Symbol("end_at")=>"Int64", Symbol("delete_at")=>"Int64", Symbol("active_stage")=>"Int64", Symbol("active_stage_title")=>"String", Symbol("post_id")=>"String", Symbol("playbook_id")=>"String", Symbol("checklists")=>"Vector{Checklist}", )
OpenAPI.property_type(::Type{ PlaybookRun }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_PlaybookRun[name]))}

function check_required(o::PlaybookRun)
    true
end

function OpenAPI.validate_property(::Type{ PlaybookRun }, name::Symbol, val)
    if name === Symbol("create_at")
        OpenAPI.validate_param(name, "PlaybookRun", :format, val, "int64")
    end
    ...
    if name === Symbol("active_stage")
        OpenAPI.validate_param(name, "PlaybookRun", :format, val, "int32")
    end
end
