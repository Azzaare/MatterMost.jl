...
@doc raw"""WebhookOnCreationPayload
...
"""
Base.@kwdef mutable struct WebhookOnCreationPayload <: OpenAPI.APIModel
    ...
    function WebhookOnCreationPayload(id, name, description, is_active, owner_user_id, team_id, channel_id, create_at, end_at, delete_at, active_stage, active_stage_title, post_id, playbook_id, checklists, channel_url, details_url, )
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("id"), id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("name"), name)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("description"), description)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("is_active"), is_active)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("owner_user_id"), owner_user_id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("team_id"), team_id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("channel_id"), channel_id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("create_at"), create_at)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("end_at"), end_at)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("delete_at"), delete_at)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("active_stage"), active_stage)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("active_stage_title"), active_stage_title)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("post_id"), post_id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("playbook_id"), playbook_id)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("checklists"), checklists)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("channel_url"), channel_url)
        OpenAPI.validate_property(WebhookOnCreationPayload, Symbol("details_url"), details_url)
...
function OpenAPI.validate_property(::Type{ WebhookOnCreationPayload }, name::Symbol, val)
    ...
    if name === Symbol("active_stage")
        OpenAPI.validate_param(name, "WebhookOnCreationPayload", :format, val, "int32")
    end
end
